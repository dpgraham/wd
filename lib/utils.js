...
let varargs = exports.varargs = function (args) {
  let fargs = new (Args)(args);
...
exports.getJsonwireError = function (status) {
  let jsonwireError = JSONWIRE_ERRORS.filter(function (err) {
